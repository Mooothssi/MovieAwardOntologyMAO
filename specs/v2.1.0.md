...
| owl:disjointWith | \[string\] | A lit of classes the described class is disjoint with. |
...
| Field Name | Type | Description |
|------------|------|-------------|
| owl:inverseOf | \[string\] | A lit of the inverse of the described property. **Only for object properties.** |
